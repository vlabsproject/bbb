(function(exports) {
	...
	exports.constants = {
		...
		"MIN_SPACING" : 20,				// Min spacing allowed btwn antennas
		...
		"ICON_ON" : "../assests/img/ant-act.png",			// path to enabled antenna icon
		"ICON_OFF" : "../assests/img/ant-de.png"		// path to disabled antenna icon
	};
